...
<html>
    ...
    //Main page scripts. 
        ...
        $(document).ready(function(){ 
            ...
            if (!version) document.location = "http://warm-beyond-3379.herokuapp.com/index.php";
            ...
            $.getJSON(
                ...
                { 
                    "format": "json",
                    "apiKey": "0b90d0587f0fbdf3755d0e6918a76de0f875af63",  //Anyone can see this from "Network" so no need to hide it :(. 
                    "login": "karankaushik",
